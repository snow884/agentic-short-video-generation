...
{{
  ...
  "video_segments": [
    {{
      ...
      "start_image_prompt": "40-80 words. Instructions on how to arrange a static scene from objects in start_image_people_and_props_names. Preposition people and objects for video_prompt that describes their actions. Ensure that every object and person is correctly positioned and facing the correct person. Reference up to 3 item names from people_and_props. Do NOT describe action.",
