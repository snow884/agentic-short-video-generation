...
{{
  ...
  "video_segments": [
    {{
      ...
      "video_prompt": "Focus strictly on motion of people and objects from start_image_prompt, and camera movement. Avoid repeating visual descriptions. Include a maximum of one action of one person or object.",
