...
{{
  ...
  "video_segments": [
    {{
      "timestamp": 0,
      "start_image_prompt": "Instructions on how to arrange a static scene - positions, scale, orientation and background referencing up to 3 item names from people_and_props. Do NOT describe action.",
      "start_image_people_and_props_names": "Unique Name,name1,name2"],
      "video_prompt": "Focus strictly on subject motion, and camera movement. Avoid repeating visual descriptions. Describe how the objects and people from  start_image_prompt are moving.",
