...
def check_text_spoken_length_matches_timestamps(segments_list: list):
    ...
    Args:
        segments_list (list): The list of video segments to check.
    ...
    #         " more than 50.00% of the segments. Mention these words less frequently in"
    ...
    #         + f"Error: The script text mentions the words {words_to_include} only in"
    #         f" {breast_mention_count} out of {len(segments_list)} segments, which is"
    #         " more than 50.00 percent of the segments. Mention these words less"
