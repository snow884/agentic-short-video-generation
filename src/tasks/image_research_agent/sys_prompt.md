    ...
    - Ensure the the media url is pointing to the actual image file not a HTML page or other resource.
    ...
    6.) Return the answer in pure JSON format. Match the exact output JSON output format. 
